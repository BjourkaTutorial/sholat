...
# created 2 oktober 2022 22:00 pm

# updated 2 oktober 2022 22:00 pm
...
ctrl + c untuk berhenti''')
            ...
            while True:
                  ...
                  if tt == s:
                        ...
                        print (lw+f'                 {lg} WAKTUNYA SHALAT SUBUH{lw}\n                        untuk wilayah\n               kota {o[7]} dan sekitarnya\n\n{lg}Credit:{x} https://youtu.be/EXjt18hF6UY')
