# sholat
# BjourkaTutorial 
# created 3, Oktober 2022 13:00pm
# updated 3 Oktober 2022 13:00 pm
#-*-coding : utf-8-*-
'''
...
def gettime():
      ...
      try:
                        ...
                        print(lg+'\nMasyaallah...\nBrother Anda lupa ngidupin jaringannya'+x)
                        input(lg+'\nEnterin aja')
                        menu()
...
def update():
      ...
      try:
            ...
            print(lg+'Astaghfirullah...brother anda lupa ngidupin jaringannya')
            exit()
...
{lg}Nama        : {lw}Sholat
{lg}Versi       : {lw}1.3 (Update: 3 Oktober 2022, 13:00PM)
{lg}Tanggal     : {lw}3 Oktober 2022, 13:00PM
...
{lg}NB          : {lw}Manusia nggak ada yang sempurna,
              sama kaya lu gk sempurna awokawok canda:v
